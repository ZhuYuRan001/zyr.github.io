...
这个例子对比三种方式执行**相同计算密集型任务**（3000 万次循环累加）的耗时：
...
<WasmPlayground
  title="示例 4：性能对比"
  wasmHex="0061736d0100000001060160017f017f03020100070b0107636f6d7075746500000a22012001017f410021010340200120006a2101200041016b220041004a0d000b20010b"
  watCode={`(module
  (func (export "compute") (param i32) (result i32)
    ...
    local.get 1))`}
  jsCode={`const ITERATIONS = 30000000;
...
Vite 对 `.wasm` 文件有**原生支持**，你可以像导入模块一样导入它——Vite 自动处理 fetch、编译和导出绑定：
